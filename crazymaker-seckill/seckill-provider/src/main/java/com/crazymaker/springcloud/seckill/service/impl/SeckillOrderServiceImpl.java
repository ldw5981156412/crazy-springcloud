...
public class SeckillOrderServiceImpl {
    ...
    public PageOut<SeckillOrderDTO> findOrderByUserID(Long userId, PageReq pageReq) {
        ...
        return DataAdapter.adapterPage(page, SeckillOrderDTO.class);
    }
    ...
    public List<SeckillOrderPO> findOrderByUserIDAndSkuId(Long userId, Long skuId) {
        ...
        return seckillOrderDao.findAll(Example.of(checkOrder));
    }
    ...
    public String clearOrderByUserID(Long userId) {
         ...
         * 创建条件对象
         */
        SeckillOrderPO checkOrder = SeckillOrderPO.builder().userId(userId).build();
        ...
        while (it.hasNext()) {
            ...
            String skuId = "seckill:queue:" + next.getSkuId();
