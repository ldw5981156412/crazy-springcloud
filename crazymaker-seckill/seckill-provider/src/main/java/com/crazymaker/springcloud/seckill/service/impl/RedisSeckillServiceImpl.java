...
public class RedisSeckillServiceImpl {
    ...
    public String getSeckillToken(String exposedKey, String userId) {
        ...
        Long res = redisRepository.executeScript(getSeckillScript(), Collections.singletonList("setToken"),
                exposedKey, userId, token);
        if (res == 2) {
    ...
    public SeckillOrderDTO executeSeckill(SeckillDTO inDto) {
         ...
         * 获取分布式锁
         */
        String lockKey = "seckill:segmentLock:" + skuId;
